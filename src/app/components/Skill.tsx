...
const Skill = () => {
  return (
    <div id="Skill">
      <section className="text-gray-600 body-font h-screen my-24">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                ...
                <div className="flex-grow">
                  ...
                  <p className="font-bold text-blue-500 text-right">60-70%</p>
                </div>
              </div>
            </div>
            {/* skill */}
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                ...
                <div className="flex-grow">
                  ...
                  <p className="font-bold text-blue-500 text-right">50-60%</p>
                </div>
              </div>
            </div>
            <div className="p-4 w-[100%] md:w-1/3">
            ...
            <div className="p-4 w-[100%] md:w-1/3">
              <div className="flex rounded-lg h-full p-8 flex-col">
                ...
                <div className="flex-grow">
                  ...
                  <p className="font-bold text-blue-500 text-right">40-50%</p>
                </div>
              </div>
            </div>
          </div>
